...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { created_day_id: @diary.created_day_id, is_edited: @diary.is_edited, text: @diary.text } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { created_day_id: @diary.created_day_id, is_edited: @diary.is_edited, text: @diary.text } }
